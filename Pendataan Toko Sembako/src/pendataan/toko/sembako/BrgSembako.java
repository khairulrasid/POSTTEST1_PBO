...
package pendataan.toko.sembako;
...
public class BrgSembako {
    ...
    BrgSembako(String namaBrg, String satuan, int stokAwal, int stokMasuk, int stokKeluar, int hargaBeli, int hargaJual, long noKodeBrg){
    ...
    public BrgSembako getBrg() {
        return Brg;
    }

    public ArrayList<BrgSembako> getBrgList() {
        return BrgList;
    }
    ...
    BrgSembako Brg;
    ArrayList<BrgSembako> BrgList = new ArrayList<>();
        ...
        while(ulang){
            ...
            if (strHargaJual.equals("0")){
                ...
                try{
                    ...
                    Brg = new BrgSembako(namaBrg, satuan, stokAwal, stokMasuk, stokKeluar, hargaBeli, hargaJual, noKodeBrg); // OBJEK ke - 1
                    BrgList.add(Brg);
    ...
    public ArrayList<BrgSembako> ubahBarang(ArrayList<BrgSembako> Brglist) {
        int ubah;
        ...
        System.out.println("\n>> Data Barang Sembako Berhasil Di Ubah <<\n");
